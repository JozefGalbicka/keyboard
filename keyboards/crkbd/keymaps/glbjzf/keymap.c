...
/**
 * Write to keylog info about pressed key and its metadata
 */
 ...
 * @return true  - QMK will process it as usual
 *         false - QMK will skip processing, handling is up to the function
 * Docs - https://github.com/qmk/qmk_firmware/blob/master/docs/custom_quantum_functions.md
 */
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  // TODO sort out where the logs are needed
